  ...
  },
{
  ...
  id: 3,
  title: "Modern E-Commerce Website (React Focus)",
  image: "/ecom1.png", 

  summary: "Frontend-focused e-commerce with reusable components and dynamic UI.",
  description:
    "A modern e-commerce web application primarily focused on frontend development using React. The project includes product listing, detailed product pages with image previews, a recommendation system for related products, add-to-cart functionality, and a basic login system. Built with reusable components and dynamic routing using React Router for seamless navigation without page reloads. Styled using Tailwind CSS for a clean, responsive, and minimal UI. This project is currently in progress, with continuous improvements and planned backend integration as part of my MERN stack journey.",
  tech: [
    "React",
    "JavaScript",
    "TailwindCSS",
  ...
  repo: "https://github.com/vaishgaikwad04/Ecommerce-App-jones-co.-.git", 
  live: "https://chic-biscuit-ef7fb1.netlify.app/decor/",
},
  ...
  live: "https://personal-portfolio-main-o9ev.onrender.com", 
},
