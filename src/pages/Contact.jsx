  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://personal-portfolio-l2ym.onrender.com/api/contact",
        {
          method: "POST",
      ...
      console.error(err);
      setSuccess("⚠️ Error sending message.");
    }
  };

  return (
    <section className="bg-black text-gray-200 py-28 px-6 md:px-16 mx-4 sm:mx-6 md:mx-16">
      {/* Heading */}
