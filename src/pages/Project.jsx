...
function Project() {
  ...
  if (!project) {
    return (
      <section className="max-w-6xl mx-auto px-4 py-24 text-white text-center">
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-14 py-16 mt-12 text-white animate-fadeIn">
        ...
        >
         ...
         {/*}   {project.live && (
              <a
                ...
                className="px-5 py-2 rounded-md bg-white text-black font-medium hover:bg-gray-200 hover:scale-105 transition transform text-center shadow-md"
              >
                Live
              </a>
            )}*/}
